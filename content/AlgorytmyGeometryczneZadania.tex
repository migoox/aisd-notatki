...
\subsection{Zadanie 5 -- Łączenie dwóch otoczek}
\paragraph{Treść:} Dane są dwa zbiory $Z_1$ i $Z_2$ takie, że dla każdych $(x1, y1) \in Z1$ i $(x2, y2) \in Z2$ zachodzi $x_1 < x_2$ (tzn. zbiór $Z_1$ jest w całości na lewo od $Z_2$). Zaprojektuj algorytm, który mając dane otoczki wypukłe zbiorów $Z_1$ i $Z_2$
